...
import com.lxj.xpopup.util.XPopupUtils.getViewRect
...
object XPopup {
        ...
        v.setOnTouchListener(object : OnTouchListener {
            override fun onTouch(v: View, event: MotionEvent): Boolean {
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    longClickPoint = PointF(event.getRawX(), event.getRawY())
                }
                if ("xpopup" == v.getTag() && event.getAction() == MotionEvent.ACTION_MOVE) {
                    //长按发送，阻断父View拦截
    ...
    class Builder(private val context: Context) {
         ...
         * @return
         */
        fun atPoint(point: PointF?): Builder {
        ...
        fun watchView(watchView: View): Builder {
            watchView.setOnTouchListener(object : OnTouchListener {
                override fun onTouch(v: View?, event: MotionEvent): Boolean {
                    if (event.getAction() == MotionEvent.ACTION_DOWN) {
                        popupInfo.touchPoint = PointF(event.getRawX(), event.getRawY())
                    }
                    return false
                }
            })
         ...
         * @return
         */
        fun popupWidth(width: Int): Builder {
         ...
         * @return
         */
        fun isCoverSoftInput(isCoverSoftInput: Boolean): Builder {
         ...
         * @return
         */
        fun hasStatusBar(hasStatusBar: Boolean): Builder {
         ...
         * @return
         */
        fun hasNavigationBar(hasNavigationBar: Boolean): Builder {
         ...
         * @return
         */
        fun isLightNavigationBar(isLightNavigationBar: Boolean): Builder {
            this.popupInfo.isLightNavigationBar = if (isLightNavigationBar) 1 else -1
            return this
        }
         ...
         * @return
         */
        fun isLightStatusBar(isLightStatusBar: Boolean): Builder {
            this.popupInfo.isLightStatusBar = if (isLightStatusBar) 1 else -1
            return this
        }
         ...
         * @return
         */
        fun isTouchThrough(isTouchThrough: Boolean): Builder {
         ...
         * @return
         */
        fun borderRadius(borderRadius: Float): Builder {
         ...
         * @return
         */
        fun positionByWindowCenter(positionByWindowCenter: Boolean): Builder {
         ...
         * @return
         */
        fun shadowBgColor(shadowBgColor: Int): Builder {
         ...
         * @return
         */
        fun keepScreenOn(keepScreenOn: Boolean): Builder {
         ...
         * @return
         */
        fun notDismissWhenTouchInView(view: View): Builder {
            if (this.popupInfo.notDismissWhenTouchInArea == null) {
                this.popupInfo.notDismissWhenTouchInArea = ArrayList<Rect>()
            }
            this.popupInfo.notDismissWhenTouchInArea!!.add(getViewRect(view))
            return this
        }
         ...
         * @return
         */
        fun customHostLifecycle(lifecycle: Lifecycle?): Builder {
        ...
        fun asConfirm(
            ...
            val popupView = ConfirmPopupView(this.context, bindLayoutId)
        ...
        fun asInputConfirm(
            ...
            val popupView = InputConfirmPopupView(this.context, bindLayoutId)
        ...
        fun asCenterList(
            ...
            val popupView = CenterListPopupView(this.context, bindLayoutId, bindItemLayoutId)
        ...
        fun asLoading(
            ...
            val popupView = LoadingPopupView(this.context, bindLayoutId)
                .setTitle(title)
                .setStyle(style)
            popupView.popupInfo = this.popupInfo
            return popupView
        ...
        fun asLoading(title: CharSequence?, style: LoadingPopupView.Style?): LoadingPopupView {
        ...
        fun asBottomList(
            ...
            val popupView = BottomListPopupView(this.context, bindLayoutId, bindItemLayoutId)
                .setStringData(title, data, iconIds)
                .setCheckedPosition(checkedPosition)
                .setOnSelectListener(selectListener)
            popupView.popupInfo = this.popupInfo
        ...
        fun asAttachList(
            ...
            val popupView = AttachListPopupView(this.context, bindLayoutId, bindItemLayoutId)
        ...
        fun asImageViewer(
            ...
            val popupView = ImageViewerPopupView(this.context)
         ...
         */
        fun asImageViewer(
            srcView: ImageView?, currentPosition: Int, urls: MutableList<Any?>?,
            srcViewUpdateListener: OnSrcViewUpdateListener?, imageLoader: XPopupImageLoader?
        ): ImageViewerPopupView {
            return asImageViewer(
                srcView, currentPosition, urls, false, true, -1, -1, -1, true,
