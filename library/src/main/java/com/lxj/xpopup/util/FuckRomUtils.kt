 ...
 */
class FuckRomUtils private constructor() {
    init {
    ...
    companion object {
        private val ROM_HUAWEI = arrayOf<String>("huawei")
        private val ROM_VIVO = arrayOf<String>("vivo")
        private val ROM_XIAOMI = arrayOf<String>("xiaomi")
        private val ROM_OPPO = arrayOf<String>("oppo")
        private val ROM_LEECO = arrayOf<String>("leeco", "letv")
        private val ROM_360 = arrayOf<String>("360", "qiku")
        private val ROM_ZTE = arrayOf<String>("zte")
        private val ROM_ONEPLUS = arrayOf<String>("oneplus")
        private val ROM_NUBIA = arrayOf<String>("nubia")
        private val ROM_COOLPAD = arrayOf<String>("coolpad", "yulong")
        private val ROM_LG = arrayOf<String>("lg", "lge")
        private val ROM_GOOGLE = arrayOf<String>("google")
        private val ROM_SAMSUNG = arrayOf<String>("samsung")
        private val ROM_MEIZU = arrayOf<String>("meizu")
        private val ROM_LENOVO = arrayOf<String>("lenovo")
        private val ROM_SMARTISAN = arrayOf<String>("smartisan")
        private val ROM_HTC = arrayOf<String>("htc")
        private val ROM_SONY = arrayOf<String>("sony")
        private val ROM_GIONEE = arrayOf<String>("gionee", "amigo")
        private val ROM_MOTOROLA = arrayOf<String>("motorola")
        ...
        private lateinit var bean: RomInfo
        ...
        val romInfo: RomInfo
             ...
             */
            get() {
                if (::bean.isInitialized) return bean
                bean = RomInfo()
